...
resource "aws_mq_configuration" "amazonmq" {
...
resource "aws_mq_broker" "amazonmq" {
  broker_name = "Symphony-Kansas-UAT"

  configuration {
    id       = "${aws_mq_configuration.amazonmq.id}"
    revision = "${aws_mq_configuration.amazonmq.latest_revision}"
  }
  ...
  #subnet_ids         = ["subnet-0c4816f7842153167", "subnet-045f15dc2d848718a"]
  #security_groups    = ["sg-09a4c12052a8fa6c6"]
