...
def createAwsProfileFile(profile, template_file, output_folder, s3Path, region_name, resource_name):
...
def createAwsS3TemplateFile(resource, template_file, output_folder, s3Path, region_name, resource_name):
    for template in template_file:
