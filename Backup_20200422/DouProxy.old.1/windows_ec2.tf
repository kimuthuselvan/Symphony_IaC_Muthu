...
resource "aws_autoscaling_group" "windowsservers" {
  ...
  name   = "${var.default_tags["project_name"]}_${var.default_tags["application_name"]}_${var.default_tags["environment_name"]}_${var.default_tags["os_type"]}_${element(split("-", var.subnet_id[count.index]),1)}"
  ...
  tag {
    key                 = "Name"
    value               = "${var.default_tags["project_name"]}_${var.default_tags["application_name"]}_${var.default_tags["environment_name"]}_${var.default_tags["os_type"]}_${element(split("-", var.subnet_id[count.index]),1)}"
    propagate_at_launch = true
  }
}
