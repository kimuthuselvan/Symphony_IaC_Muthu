...
resource "aws_alb" "aws_security_alb" {
  name     = "${var.default_tags["project_name"]}-${var.default_tags["client_name"]}-${var.default_tags["security_zone"]}-ALB"
  internal = true
...
resource "aws_alb_target_group" "security-group" {
  name       = "${var.default_tags["project_name"]}-${var.default_tags["client_name"]}-${var.default_tags["security_zone"]}-TargetGroup"
...
resource "aws_security_group" "security_group" {
  name        = "${var.default_tags["project_name"]}_${var.default_tags["client_name"]}_${var.default_tags["security_zone"]}_${var.default_tags["os_type"]}"
...
resource "aws_autoscaling_group" "linuxservers" {
  name   = "${var.default_tags["project_name"]}_${var.default_tags["client_name"]}_${var.default_tags["security_zone"]}_${var.default_tags["os_type"]}_ASG"
...
resource "aws_autoscaling_policy" "linuxautopolicy" {
  name   = "${var.default_tags["project_name"]}_${var.default_tags["client_name"]}_${var.default_tags["security_zone"]}_${var.default_tags["os_type"]}_ASGPolicy"
...
resource "aws_launch_configuration" "launchlinux" {
  name   = "${var.default_tags["project_name"]}_${var.default_tags["client_name"]}_${var.default_tags["security_zone"]}_${var.default_tags["os_type"]}_LC"
  security_groups = [aws_security_group.security_group.id]
