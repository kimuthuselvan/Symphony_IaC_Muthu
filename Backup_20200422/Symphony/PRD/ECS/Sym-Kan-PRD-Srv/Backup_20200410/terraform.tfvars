...
ecs_name = "Sym-Kan-PRD-Srv"

vpc_name        = [ "Kansas_Prod_App_VPC" ]
subnet_names    = [ "Kansas_Prod_App_AZ-A", "Kansas_Prod_App_AZ-B" ]

#key_name = "Sym-Kan-PRD-Srv-Key"
...
cpu_threshold = 70
emails = [ "EHIAWSSUPPORT@hcl.com", "michael.lindskov@emergentholdingsinc.com", "Michael.Barron@advantasure.com", "symphony-error-notify-prod@advantasure.com" ]
