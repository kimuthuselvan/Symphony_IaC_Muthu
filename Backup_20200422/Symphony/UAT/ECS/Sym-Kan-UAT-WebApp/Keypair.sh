...
case $ACTION in
deploy)
  echo -e "$INFO Generating new Keypair for ECS: $ECS_NAME ... \c"
  ...
  ;;
destroy)
  echo -e "$WARN Destroying Keypair for ECS: $ECS_NAME ... \c"
